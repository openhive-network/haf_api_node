...
zfs umount "${ZPOOL}/${TOP_LEVEL_DATASET}/logs"
zfs umount "${ZPOOL}/${TOP_LEVEL_DATASET}/blockchain"
zfs umount "${ZPOOL}/${TOP_LEVEL_DATASET}"

zfs rollback "${ZPOOL}/${TOP_LEVEL_DATASET}@${SNAPSHOT_NAME}"
zfs rollback "${ZPOOL}/${TOP_LEVEL_DATASET}/blockchain@${SNAPSHOT_NAME}"
zfs rollback "${ZPOOL}/${TOP_LEVEL_DATASET}/logs@${SNAPSHOT_NAME}"
...
zfs mount "${ZPOOL}/${TOP_LEVEL_DATASET}/logs"
